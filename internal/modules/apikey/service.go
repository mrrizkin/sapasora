...
func (s *APIKeyServiceImpl) GetAPIKeyByPublicIDForUser(ctx context.Context, publicID string, userID uint) (*APIKey, error) {
	return s.repo.GetAPIKeyByPublicIDForUser(ctx, publicID, userID)
}
