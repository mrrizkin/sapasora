...
type CanSendAudioGateway struct{}

func (p *CanSendAudioGateway) Name() string { return "can_send_audio_gateway" }
func (p *CanSendAudioGateway) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanSendAudioGateway,
		"you does not have permission to send audio gateway",
	)
}
