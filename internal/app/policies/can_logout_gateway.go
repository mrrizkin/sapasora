...
type CanLogoutGateway struct{}

func (p *CanLogoutGateway) Name() string { return "can_logout_gateway" }
func (p *CanLogoutGateway) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanLogoutGateway,
		"you does not have permission to logout gateway",
	)
}
