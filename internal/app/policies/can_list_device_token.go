...
type CanListDeviceToken struct{}

func (p *CanListDeviceToken) Name() string { return "can_list_device_token" }
func (p *CanListDeviceToken) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanListDeviceToken,
		"you does not have permission to list device token",
	)
}
