...
type CanListAPIKey struct{}

func (p *CanListAPIKey) Name() string { return "can_list_api_key" }
func (p *CanListAPIKey) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanListAPIKey,
		"you does not have permission to list api key",
	)
}
