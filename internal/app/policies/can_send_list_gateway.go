...
type CanSendListGateway struct{}

func (p *CanSendListGateway) Name() string { return "can_send_list_gateway" }
func (p *CanSendListGateway) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanSendListGateway,
		"you does not have permission to send list gateway",
	)
}
