...
type CanUpdateDevice struct{}

func (p *CanUpdateDevice) Name() string { return "can_update_device" }
func (p *CanUpdateDevice) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		...
		"you does not have permission to update device",
	)
}
