...
type CanSendTextGateway struct{}

func (p *CanSendTextGateway) Name() string { return "can_send_text_gateway" }
func (p *CanSendTextGateway) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanSendTextGateway,
		"you does not have permission to send text gateway",
	)
}
