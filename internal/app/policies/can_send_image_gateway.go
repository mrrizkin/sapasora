...
type CanSendImageGateway struct{}

func (p *CanSendImageGateway) Name() string { return "can_send_image_gateway" }
func (p *CanSendImageGateway) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanSendImageGateway,
		"you does not have permission to send image gateway",
	)
}
