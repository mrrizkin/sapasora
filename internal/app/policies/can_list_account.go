...
type CanListAccount struct{}

func (p *CanListAccount) Name() string { return "can_list_account" }
func (p *CanListAccount) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanListAccount,
		"you does not have permission to list account",
	)
}
