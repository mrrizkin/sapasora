...
type CanListRole struct{}

func (p *CanListRole) Name() string { return "can_list_role" }
func (p *CanListRole) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanListRole,
		"you does not have permission to list role",
	)
}
