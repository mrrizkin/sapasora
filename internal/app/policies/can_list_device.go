...
type CanListDevice struct{}

func (p *CanListDevice) Name() string { return "can_list_device" }
func (p *CanListDevice) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanListDevice,
		"you does not have permission to list devices",
	)
}
