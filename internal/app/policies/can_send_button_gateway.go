...
type CanSendButtonGateway struct{}

func (p *CanSendButtonGateway) Name() string { return "can_send_button_gateway" }
func (p *CanSendButtonGateway) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanSendButtonGateway,
		"you does not have permission to send button gateway",
	)
}
