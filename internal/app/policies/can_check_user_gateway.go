...
type CanCheckUserGateway struct{}

func (p *CanCheckUserGateway) Name() string { return "can_check_user_gateway" }
func (p *CanCheckUserGateway) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanCheckUserGateway,
		"you does not have permission to check user gateway",
	)
}
