...
type CanGetAccount struct{}

func (p *CanGetAccount) Name() string { return "can_get_account" }
func (p *CanGetAccount) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		...
		"you does not have permission to get account",
	)
}
