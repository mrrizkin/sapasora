...
type CanGetDevice struct{}

func (p *CanGetDevice) Name() string { return "can_get_device" }
func (p *CanGetDevice) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanGetDevice,
		"you does not have permission to get device",
	)
}
