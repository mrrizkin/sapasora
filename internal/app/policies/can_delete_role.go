...
type CanDeleteRole struct{}

func (p *CanDeleteRole) Name() string { return "can_delete_role" }
func (p *CanDeleteRole) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanDeleteRole,
		"you does not have permission to delete role",
	)
}
