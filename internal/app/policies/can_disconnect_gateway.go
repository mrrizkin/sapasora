...
type CanDisconnectGateway struct{}

func (p *CanDisconnectGateway) Name() string { return "can_disconnect_gateway" }
func (p *CanDisconnectGateway) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanDisconnectGateway,
		"you does not have permission to disconnect gateway",
	)
}
