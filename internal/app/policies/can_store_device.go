...
type CanStoreDevice struct{}

func (p *CanStoreDevice) Name() string { return "can_store_device" }
func (p *CanStoreDevice) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanStoreDevice,
		"you does not have permission to store device",
	)
}
