...
type CanDeleteDevice struct{}

func (p *CanDeleteDevice) Name() string { return "can_delete_device" }
func (p *CanDeleteDevice) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		...
		"you does not have permission to delete device",
	)
}
