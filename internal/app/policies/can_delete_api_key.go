...
type CanDeleteAPIKey struct{}

func (p *CanDeleteAPIKey) Name() string { return "can_delete_api_key" }
func (p *CanDeleteAPIKey) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanDeleteAPIKey,
		"you does not have permission to delete api key",
	)
}
