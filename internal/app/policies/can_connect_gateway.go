...
type CanConnectGateway struct{}

func (p *CanConnectGateway) Name() string { return "can_connect_gateway" }
func (p *CanConnectGateway) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanConnectGateway,
		"you does not have permission to connect gateway",
	)
}
