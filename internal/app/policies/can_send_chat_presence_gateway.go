...
type CanSendChatPresenceGateway struct{}

func (p *CanSendChatPresenceGateway) Name() string { return "can_send_chat_presence_gateway" }

func (p *CanSendChatPresenceGateway) Authorize(
	...
	satpam.Assert(
		permission.CanSendChatPresenceGateway,
		"you does not have permission to send chat presence gateway",
	)
}
