...
type CanSendVideoGateway struct{}

func (p *CanSendVideoGateway) Name() string { return "can_send_video_gateway" }
func (p *CanSendVideoGateway) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanSendVideoGateway,
		"you does not have permission to send video gateway",
	)
}
