...
type CanUpdateAccount struct{}

func (p *CanUpdateAccount) Name() string { return "can_update_account" }
func (p *CanUpdateAccount) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanUpdateAccount,
		"you does not have permission to update account",
	)
}
