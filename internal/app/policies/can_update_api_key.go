...
type CanUpdateAPIKey struct{}

func (p *CanUpdateAPIKey) Name() string { return "can_update_api_key" }
func (p *CanUpdateAPIKey) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanUpdateAPIKey,
		"you does not have permission to update api key",
	)
}
