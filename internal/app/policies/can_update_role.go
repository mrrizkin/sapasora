...
type CanUpdateRole struct{}

func (p *CanUpdateRole) Name() string { return "can_update_role" }
func (p *CanUpdateRole) Authorize(sub *satpam.Attribute, res map[string]*satpam.Attribute) {
	...
	satpam.Assert(
		permission.CanUpdateRole,
		"you does not have permission to update role",
	)
}
